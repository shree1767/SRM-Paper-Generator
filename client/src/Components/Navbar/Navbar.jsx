  ...
  return (
    <nav className="bg-white shadow-lg py-2 px-4 md:px-[5vw] flex justify-between items-center border-t-[8px] border-[#0C4DA1] fixed w-full top-0">
      <div className="flex items-center">
        <Link to="/">
          <img src={logo} alt="Logo" className="md:w-[12vw] w-[30vw]" />
        </Link>
      </div>
      <div className="relative">
        ...
        {dropdownOpen && (
          <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-300 shadow-lg rounded-lg cursor-pointer">
            <Link
              to="/"
